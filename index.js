...
const bad = ["fuck","stfu" ,"shush", "puta", "shit", "nub", "cock","puta","shit","gay","niga","mom","bitch","nigga","fk","foff", "nigger" , "niga", "**", "ga y","rat","noob","die","baby","sex","por","pen","vag","hub","peanutnoob","suck","sick","dic"]
var yoo = ["balwan", "token", "grabber", "peanoob"]
...
const token = 'ODkzNTY3MTM0MjM0NDcyNDk4.YVdfeQ.Fb50BpDwmvj74zbOBeBOiN-9l1I'
...
if(message.content.toLowerCase() == ('lostprefix')) {
    ...
    if(guilds.Guilds[message.guild.id].badword == "on"){
        ...
        if(!message.member.hasPermission('ADMINISTRATOR') || !message.member.permissions.has('ADMINISTRATOR') || !message.member.permissions.has('MANAGE_MESSAGES')) {
            if(message.content.toLowerCase().includes(yoo[i])) {
                message.delete()
                const reason = "U Got Hacked By A Noob"
